...
The default image is built from Ubuntu 22.04 with Slurm 25.05.9. The image supports multiple user IDs:
...
- `SLURM_VERSION`: Slurm version to build (default: 25.05.9)
